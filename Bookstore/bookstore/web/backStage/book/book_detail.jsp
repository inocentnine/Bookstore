...
<ul class="nav nav-pills">
    ...
    <li role="presentation" class="active"><a href="../backStage/book/bookbookManage.jsp">图书管理</a></li>
    ...
    <div class="input-group">
        <span class="input-group-btn">
            ...
            <form action="/Servlet/bookSearchServlet" method="post">
                ...
                <button class="btn btn-danger" type="submit" onclick=window.open("../backStage/book//book_add.html")>添加图书</button>
            </form>
    ...
    <div>
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td><%=book.getType()%></td>
                <td><%=book.getPrice()%></td>
                <td><%=book.getBooksum()%></td>
                <td>

                    <form action="/Servlet/bookUpdateServlet" method="post">
                        <input class="btn btn-default" type="submit" value="修改信息">
                        <input type="checkbox" name="bookId01" value=<%=book.getId()%> />
                    </form>

                </td>
                <td>
                    <form action="/Servlet/bookDeletServlet" method="post">
                        <input class="btn btn-danger" type="submit" value="删除图书">
