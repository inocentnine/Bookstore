...
<form  name="search" method="post" action="http://localhost:8080/UpdateServlet">
    <br>
    <div class="col-lg-6 col-md-offset-3">
        <div class="input-group">
            <input   name="ordernumber" type="text" placeholder="请输入希望修改的订单编号" class="form-control">
            <input   name="status" type="text" placeholder="请输入希望更改的订单状态" class="form-control">
            <button type="submit" class="btn btn-default">修改订单状态</button>
        </div>
    </div>
</form>
